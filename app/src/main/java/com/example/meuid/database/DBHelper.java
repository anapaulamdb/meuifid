...
public class DBHelper extends SQLiteOpenHelper{
    public static final String DATABASE_NAME = "meuifId-0.db";
    ...
    public Cursor carregaDadoById(int id){
        Cursor cursor;
        String[] campos =  {DBHelper.MATRICULA, DBHelper.CPF, DBHelper.CURSO, DBHelper.CAMPUS, DBHelper.EMAIL, DBHelper.SENHA, DBHelper.IMAGEM, DBHelper.APROVADO};
